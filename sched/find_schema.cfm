...
<cfloop query="getDistinctTables">
    ...
    <cfquery result="result"  name="getTableSchema" datasource="abod">
        ...
        AND TABLE_NAME = <cfquery result="result" param value="#getDistinctTables.qry_table#" cfsqltype="cf_sql_varchar">
    ...
    <cfquery result="result"  datasource="abod">
        ...
        VALUES (
            <cfquery result="result" param value="#getDistinctTables.qry_table#" cfsqltype="cf_sql_varchar" maxlength="255">,
            <cfquery result="result" param value="#createScriptContent#" cfsqltype="cf_sql_varchar">
        )
    </cfquery>
