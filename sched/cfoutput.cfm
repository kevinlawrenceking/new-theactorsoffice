    ...
    <cfif fileExists(fullFilePath)>
        ...
        <cftry>
            <cfquery result="result"  datasource="abod">
                UPDATE tao_files
                SET qry_no = <cfquery result="result" param value="#difference#" cfsqltype="cf_sql_integer">
                WHERE id = <cfquery result="result" param value="#getIncludeFiles.id#" cfsqltype="cf_sql_integer">
            </cfquery>
        <cfcatch>
