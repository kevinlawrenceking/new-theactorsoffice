        ...
        <cfloop condition="startPos LTE len(fileContent)">
            ...
            <cfif startQuery GT 0 AND endQuery GT startQuery>
                ...
                <cftry>
                    ...
                    <cfcatch>
                        <cfoutput>StartQuery: #startQuery#, EndQuery: #endQuery#, FullFileContentLength: #len(fileContent)#</cfoutput>
                        <cfdump var="#cfcatch#">
                        <cfabort>
                    </cfcatch>
                </cftry>
                ...
                <cfif queryStart GT 0>
                    ...
                    <cfcatch>
                        <cfoutput>QueryStart: #queryStart#, EndQuery: #endQuery#, FileContentLength: #len(fileContent)#</cfoutput>
                        <cfdump var="#cfcatch#">
                        <cfabort>
                    </cfcatch>
                    </cftry>
                    ...
                    <cfif REFindNoCase(qryTypePattern, strippedQueryBlock)>
                        <cfset qry_Type = UCase(mid(strippedQueryBlock, REFindNoCase(qryTypePattern, strippedQueryBlock), 6))>
                    <cfelse>
                    ...
                    <cfif qry_Type EQ "SELECT" OR qry_Type EQ "DELETE">
                        ...
                        <cfif fromPos GT 0>
                            <!--- Corrected Mid() function with 3 parameters --->
                            <cftry>
                                <cfset tableName = ListFirst(mid(strippedQueryBlock, fromPos + 5, len(strippedQueryBlock) - (fromPos + 4)), " ")>
                            <cfcatch>
                                <cfoutput>FromPos: #fromPos#, StrippedQueryBlockLength: #len(strippedQueryBlock)#</cfoutput>
                                <cfdump var="#cfcatch#">
                                <cfabort>
                            </cfcatch>
                            </cftry>
                    ...
                    <cfelseif qry_Type EQ "UPDATE">
                        ...
                        <cfif updatePos GT 0>
                            ...
                            <cfcatch>
                                <cfoutput>UpdatePos: #updatePos#, StrippedQueryBlockLength: #len(strippedQueryBlock)#</cfoutput>
                                <cfdump var="#cfcatch#">
                                <cfabort>
                            </cfcatch>
                            </cftry>
                    ...
                    <cfelseif qry_Type EQ "INSERT">
                        ...
                        <cfif insertPos GT 0>
                            ...
                            <cfcatch>
                                <cfoutput>InsertPos: #insertPos#, StrippedQueryBlockLength: #len(strippedQueryBlock)#</cfoutput>
                                <cfdump var="#cfcatch#">
                                <cfabort>
                            </cfcatch>
                            </cftry>
