...
<cfloop query="getUniqueFunctions">
    ...
    <cfquery result="result"  datasource="abod">
        ...
        VALUES (
            <cfquery result="result" param value="#getUniqueFunctions.component_id#" cfsqltype="cf_sql_integer">,
            <cfquery result="result" param value="#functionName#" cfsqltype="cf_sql_varchar">,
            <cfquery result="result" param value="#getUniqueFunctions.qry_type#" cfsqltype="cf_sql_varchar">,
            <cfquery result="result" param value="#functionName#" cfsqltype="cf_sql_varchar">
        );
    </cfquery>
    ...
    <cfquery result="result"  datasource="abod">
        UPDATE tao_files
        SET function_id = <cfquery result="result" param value="#getNewFunctionId.id#" cfsqltype="cf_sql_integer">
        WHERE qry_view = <cfquery result="result" param value="#getUniqueFunctions.qry_view#" cfsqltype="cf_sql_varchar">
    </cfquery>
</cfloop>
