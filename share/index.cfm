    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
            ...
            <a href="/app/" class="logo logo-dark text-center">
                <span class="logo-sm">
                    <img src="<cfoutput>#application.application.imagesUrl#</cfoutput>/logo-sm.png" alt="" height="30">
            ...
            <a href="/app/" class="logo logo-light text-center">
                ...
                <span class="logo-lg">
                    <img src="<cfoutput>#application.application.imagesUrl#</cfoutput>/logo-light.png" alt="" height="30">
                </span>
            </a>
        </div>
