<cfcomponent displayname="NotificationService" hint="Handles operations for Notification table" output="false"> 
    ...
    <cffunction name="SELfunotifications_24711" access="public" returntype="query">
        ...
        <cfquery result="result"  name="notsall">
            ...
            WHERE f.contactID = <cfquery result="result" param value="#arguments.currentid#" cfsqltype="cf_sql_integer">
        </cfquery>
    ...
    <cffunction name="SELfunotifications_24706" access="public" returntype="query">
        ...
        <cfquery result="result"  name="notsActive">
            ...
            WHERE f.contactID = <cfquery result="result" param value="#arguments.currentid#" cfsqltype="cf_sql_integer">
              AND f.suID = <cfquery result="result" param value="#arguments.sysActiveSuid#" cfsqltype="cf_sql_integer">
              AND au.userID = <cfquery result="result" param value="#arguments.userid#" cfsqltype="cf_sql_integer">
              AND n.notStartDate IS NOT NULL
              AND DATE(n.notStartDate) <= <cfquery result="result" param value="#DateFormat(Now(), 'yyyy-mm-dd')#" cfsqltype="cf_sql_date">
...
<cffunction name="SELfunotifications_24709" access="public" returntype="query">
    ...
    <cfquery name="result">
        ...
        WHERE 
            au.userid = <cfquery result="result" param value="#arguments.userID#" cfsqltype="CF_SQL_INTEGER"> 
            AND c.userid = au.userid 
            AND n.notstartdate IS NOT NULL 
            AND DATE(n.notstartdate) <= <cfquery result="result" param value="#DateFormat(Now(),'yyyy-mm-dd')#" cfsqltype="CF_SQL_DATE"> 
            AND n.notstatus = <cfquery result="result" param value="Pending" cfsqltype="CF_SQL_VARCHAR">
        ORDER BY 
...
<cffunction name="INSnotifications" access="public" returntype="void">
    ...
    <cfquery result="result" >
        INSERT INTO notifications (
            ...
            <cfquery result="result" param value="Maintenance system created for #arguments.new_contactname#" cfsqltype="CF_SQL_VARCHAR">,
            <cfquery result="result" param value="#arguments.userid#" cfsqltype="CF_SQL_INTEGER">,
            <cfquery result="result" param value="/app/contact/?contactid=#arguments.contactid#&t4=1" cfsqltype="CF_SQL_VARCHAR">,
            <cfquery result="result" param value="Maintenance System Created!" cfsqltype="CF_SQL_VARCHAR">,
            <cfquery result="result" param value="System Added" cfsqltype="CF_SQL_VARCHAR">,
...
<cffunction name="INSnotifications_23937" access="public" returntype="void">
    ...
    <cfquery result="result" >
        INSERT INTO notifications (
            ...
            <cfquery result="result" param value="Appointment completed. Follow-Up with #arguments.new_contactname#" cfsqltype="CF_SQL_VARCHAR">,
            <cfquery result="result" param value="#arguments.new_userid#" cfsqltype="CF_SQL_INTEGER">,
            <cfquery result="result" param value="/app/contact/?contactid=#arguments.new_contactid#&t4=1" cfsqltype="CF_SQL_VARCHAR">,
            <cfquery result="result" param value="Follow-Up System Created!" cfsqltype="CF_SQL_VARCHAR">,
            <cfquery result="result" param value="System Added" cfsqltype="CF_SQL_VARCHAR">,
            <cfquery result="result" param value="#arguments.new_contactid#" cfsqltype="CF_SQL_INTEGER">,
            <cfquery result="result" param value="0" cfsqltype="CF_SQL_BIT">,
            <cfquery result="result" param value="#arguments.sunotes#" cfsqltype="CF_SQL_LONGVARCHAR">
        )
    </cfquery>
</cffunction>
...
<cffunction name="UPDnotifications" access="public" returntype="void">
    ...
    <cfquery result="result"  name="updateQuery">
        ...
        SET `read` = 1 
        WHERE id = <cfquery result="result" param cfsqltype="cf_sql_integer" value="#arguments.notificationId#">
    </cfquery>
</cffunction>
...
<cffunction name="UPDnotifications_24009" access="public" returntype="void">
    ...
    <cftry>
        <cfquery result="result"  datasource="abod">
            UPDATE notifications 
            SET trash = 1 
            WHERE userid = <cfquery result="result" param cfsqltype="cf_sql_integer" value="#arguments.userid#"> 
            AND trash = 0
        </cfquery>
...
<cffunction name="getRemindersTotal" access="public" returntype="numeric">
    ...
    <cftry>
        ...
        <cfquery result="result"  name="reminders" datasource="abod">
            ...
            AND c.userid = au.userid
            AND n.notstartdate IS NOT NULL
            AND DATE(n.notstartdate) <= <cfquery result="result" param value="#currentStartDate#" cfsqltype="CF_SQL_DATE">
