                        ...
                        <div class="form-switch col-md-3 col-sm-6 col-xs-6">
                            <cfif #projectdetails.isdirect# is "0">
                                ...
                                <cfif #rolecheck.iscallback# is "1">
                                    <input class="form-check-input form-check-input-callback" type="checkbox" id="new_iscallback" name="new_iscallback" value="1" <cfif #rolecheck.iscallback# is "1" ></cfif>
 checked </cfif>
                                ...
                                <cfelse>
                                    <input class="form-check-input form-check-input-callback" type="checkbox" data-bs-toggle="modal" data-bs-target="##StatusConfirm2" id="new_iscallback" name="new_iscallback" value="1" <cfif #rolecheck.iscallback# is "1" ></cfif>
 checked </cfif>
                        ...
                        <div class="form-switch col-md-3 col-sm-6 col-xs-6">
                            <cfif #projectdetails.isdirect# is "0">
                                ...
                                <cfif #rolecheck.isRedirect# is "1">
                                    <input class="form-check-input form-check-input-Redirect" type="checkbox" id="new_isRedirect" name="new_isRedirect" value="1" <cfif #rolecheck.isRedirect# is "1" ></cfif>
 checked </cfif>
              ...
              data-bs-toggle="modal" data-bs-target="##StatusCancel3"  
                            ...
                            <cfelse>
                                ...
                                <input class="form-check-input form-check-input-Redirect" type="checkbox" data-bs-toggle="modal" data-bs-target="##StatusConfirm3" id="new_isRedirect" name="new_isRedirect" value="1" <cfif #rolecheck.isRedirect# is "1" ></cfif>
 checked </cfif>
...
<cfif #rolecheck.isPin# is "1">
                                ...
                                <input class="form-check-input form-check-input-Pin" type="checkbox" id="new_isPin" name="new_isPin" value="1" <cfif #rolecheck.isPin# is "1" ></cfif>
 checked
                            </cfif>
                      ...
                      data-bs-toggle="modal" data-bs-target="##StatusCancel4"  
                            ...
                            <cfelse>
                                ...
                                <input class="form-check-input form-check-input-Pin" type="checkbox" data-bs-toggle="modal" data-bs-target="##StatusConfirm4" id="new_isPin" name="new_isPin" value="1" <cfif #rolecheck.isPin# is "1" ></cfif>
 checked </cfif>
...
<cfif #Booked_check.recordcount# is not "0"> 
 <a href="" data-bs-target="##RemoveBook" data-bs-toggle="modal"></cfif>
                            ...
                            <cfif #rolecheck.isBooked# is "1">
                                ...
                                <input class="form-check-input form-check-input-Booked" type="checkbox" id="new_isBooked" name="new_isBooked" value="1" <cfif #rolecheck.isBooked# is "1" ></cfif>
 checked
                            </cfif>
                     ...
                     data-bs-toggle="modal" data-bs-target="##StatusCancel5" 
                            ...
                            <cfelse>
                                ...
                                <input class="form-check-input form-check-input-Booked" type="checkbox" data-bs-toggle="modal" data-bs-target="##StatusConfirm5" id="new_isBooked" name="new_isBooked" value="1" <cfif #rolecheck.isBooked# is "1" ></cfif>
 checked </cfif>
