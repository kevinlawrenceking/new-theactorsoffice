                ...
                <cfloop query="birthdays">
                    ...
                    <div class="col-md-2 col-lg-2" style="margin-top:7px;margin-left:7px;">
                        <a href="/app/contact/?contactid=#birthdays.contactid#&t1=1" title="#birthdays.col1#">
                            <cfif isImageFile(session.userContactsUrl & "/" & birthdays.contactid & "/avatar.jpg")> <!--- Rule 3 --->
...
<!--- Include script name --->
<cfset scriptNameInclude = "/include/" & ListLast(GetCurrentTemplatePath(), ' \')> <!--- Rule 5 --->

<!--- Modifications were made based on rules 3 and 5. --->