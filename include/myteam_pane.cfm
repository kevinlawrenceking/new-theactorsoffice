        ...
        <cfloop query="myteam">
            ...
            <div class="col-xl-3 col-md-4 col-sm-6 col-xs-12 ">
                <div class="text-center card-box border border-secondary border-1 h-100">
                    <div class="pt-1 pb-1">
                        <cfset contactAvatarFilename = "#session.userContactsPath#/#myteam.contactid#/avatar.jpg" />
                        ...
                        <h5>
                            ...
                            <cfloop query="mytags">#mytags.valuetext#</cfloop>
                        </h5>
...
<!--- Changes made: Removed unnecessary cfoutput tags, standardized variable names and casing, improved conditional checks, ensured consistent attribute quoting, spacing, and formatting, used double pound signs for color codes. --->