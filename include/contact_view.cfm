...
<div class="card">
    ...
    <div class="card-body py-2 px-3 border-bottom border-light">
        <A href="/app/image-upload/?contactid=#contactid#&ref_pgid=#pgid#">
            <figure>
                <!--- Check if the browser contact avatar filename is an image file --->
                <cfif isimagefile(browser_contact_avatar_filename)>
                    <img src="#browser_contact_avatar_filename#?ver=#rand()#" class="mr-3 rounded-circle gambar img-responsive img-thumbnail" style="height:120px;" alt="profile-image" id="item-img-output" />
                <CFELSE>
                    <img src="#application.defaultAvatarUrl#" class="mr-3 rounded-circle gambar img-responsive img-thumbnail" style="height:120px;" alt="profile-image" id="item-img-output" />
                </cfif>
            </figure>
        </A>
        <h4 class="mt-0 mb-0">
            <a href="javascript:;" data-bs-remote="true" data-bs-toggle="modal" data-bs-target="#remoteUpdateName" data-bs-placement="top" title="Update Contact" data-bs-original-title="Update Contact">
                #details.fullname#
                <cfif TRIM(details.fullname) is ""> Add Name </cfif>
                <cfif details.contactpronoun is not "">(details.contactpronoun)</cfif>
            </a>
        </h4>
        <HR/>
            ...
            <div class="row">
                <div class="col-12 col-md-12 col-lg-6">
                    ...
                    <p class="mt-1 mb-0 text-muted font-14">
                        ...
                        <a href="javascript:;" data-bs-remote="true" data-bs-toggle="modal" data-bs-target="##remoteUpdateName" data-bs-placement="top" title="Update Contact" data-bs-original-title="Update Contact">
                            <cfif details.contactBirthday is not "">#month(details.contactbirthday)#/#day(details.contactbirthday)#</cfif>
                            <cfif details.contactBirthday is ""> Add Birthday </cfif>
                        </a>
                    </p>
