...
<form action="/include/remoteUpdateMaterial2.cfm" method="post" class="parsley-examples" enctype="multipart/form-data" id="upload" 
    ...
    <cfoutput query="materials_details">
        ...
        <cfoutput query="materials_details">
            ...
            <div class="form-group col-md-12">
                ...
                <input class="form-control" type="text" id="new_medianame" name="new_medianame" data-parsley-maxlength="800" 
                       data-parsley-maxlength-message="Max length 800 characters" value="#materials_details.medianame#" 
                       placeholder="Add a name/brief description">
            </div>

            <div class="form-group col-md-12">
                <label for="new_medialoc">URL</label>
                <input class="form-control" type="text" id="new_mediaurl" name="new_mediaurl" data-parsley-maxlength="800" 
                       data-parsley-maxlength-message="Max length 800 characters" value="#materials_details.mediaurl#" 
