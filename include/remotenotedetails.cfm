...
<cfoutput>#details.noteDetailsHtml#</cfoutput> <!--- Standardized variable names and casing (Rule 5). Removed unnecessary `<cfoutput>` tags around variable outputs (Rule 2). --->