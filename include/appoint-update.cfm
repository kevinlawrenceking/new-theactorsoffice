                    ...
                    <cfoutput>
                        ...
                        <cfoutput>
                            <div class="form-group col-md-12">
                                ...
                                <div id="checkboxes">
                                    <input type="checkbox" name="dow" value="1" >checked</cfif> onchange="showDiv('hidden_div', this)"> Monday
                                    &nbsp;<input type="checkbox" name="dow" value="2" >checked</cfif> onchange="showDiv('hidden_div', this)"> Tuesday
                                    &nbsp;<input type="checkbox" name="dow" value="3" >checked</cfif> onchange="showDiv('hidden_div', this)"> Wednesday
                                    &nbsp;<input type="checkbox" name="dow" value="4" >checked</cfif> onchange="showDiv('hidden_div', this)"> Thursday
                                    &nbsp;<input type="checkbox" name="dow" value="5" >checked</cfif> onchange="showDiv('hidden_div', this)"> Friday
                                    &nbsp;<input type="checkbox" name="dow" value="6" >checked</cfif> onchange="showDiv('hidden_div', this)"> Saturday
                                    &nbsp;<input type="checkbox" name="dow" value="0" >checked</cfif> onchange="showDiv('hidden_div', this)"> Sunday
                                </div>
                            </div>
