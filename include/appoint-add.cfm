<!--- Handles the creation of an appointment with various input fields and validation --->
                        ...
                        <div class="form-group col-md-6">
                            ...
                            >
                                ...
                                <cfloop condition="startTime LTE endTime">
                                    ...
                                    <cfoutput>
                                        <option value="#timeString#">#displayTime#</option>
                                    </cfoutput>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            >
                                <cfoutput query="durations">
                                    <option value="#durations.durid#">#durations.durname#</option>
                                </cfoutput>
                            </select>
                        </div>
