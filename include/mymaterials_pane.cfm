                ...
                <cfoutput>
                    ...
                    <tr role="row">
                        ...
                        <td class="text-nowrap">
                            <a href="##" id="downloadLink_#headshots_sel.mediaid#" 
                        ...
                        <td class="text-nowrap">
                            <cfif #headshots_sel.mediaurl# is not "">
                                <a href="#headshots_sel.mediaurl#" target="new" 
                                   style="text-decoration: underline; color: blue;">
                        ...
                        <td class="text-nowrap">
                            <cfif #numberformat(events.recordcount)# is not "0">
                                <a style="text-decoration: underline; color: blue;" 
                                   href="/app/auditions/?materials=#materials#">
                                    #numberformat(events.recordcount)#
                                </a>
                            <cfelse>
                                0
                            </cfif>
