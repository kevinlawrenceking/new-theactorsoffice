                            ...
                            <script>
                              $(document).ready(function () {
                                $("#remoteUpdate<cfoutput>C#cu.itemid#</cfoutput>").on("show.bs.modal", function (event) {
                                  ...
                                  $(this)
                                    .find(".modal-body")
                                    .load("<cfoutput>/include/remoteupdatec.cfm?userid=#userid#&itemid=#cu.itemid#</cfoutput>");
                                });
                              });
                            </script>
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                      ...
                                      <p>
                                        ...
                                        #dateformat(sysactive.sustartdate)#</p>
                                      <cfif #sysactive.suenddate# is not "">
                                        <p>
                                          <strong>Completed:</strong>
                                          #dateformat(sysactive.suenddate)#</p>
                                      </cfif>
                                    </div>
                                  </div>
                                </div>
                            ...
                            <script>
                              $(document).ready(function () {
                                $("#remoteAdd<cfoutput>C#c.catid#</cfoutput>").on("show.bs.modal", function (event) {
                                  ...
                                  $(this)
                                    .find(".modal-body")
                                    .load("<cfoutput>/include/remoteAddC.cfm?catid=#c.catid#&userid=#userid#&contactid=#currentid#</cfoutput>");
                                });
                              });
                            </script>
                                        ...
                                        <cfoutput>
                                          ...
                                          <center>
                                            ...
                                            <cfif NOT fileExists(avatar_path)>
                                              ...
                                              <img src="#default_avatar#" class="mr-3 rounded-circle gambar img-responsive img-thumbnail" style="max-width:180px;width:100%" alt="profile-image" id="item-img-output"/>
                                            ...
                                            <cfelse>
                                              ...
                                              <img src="#contact_avatar#?rev=#rand()#" class="mr-3 rounded-circle gambar img-responsive img-thumbnail" style="max-width:180px;width:100%" alt="profile-image" id="item-img-output"/>
                                            </cfif>
                                ...
                                <div class="card-body">
                                  <ul class="nav nav-pills navtab-bg nav-justified p-1" role="tablist">
                                    ...
                                    <li class="nav-item">
                                      ...
                                      <a href="#notes" data-bs-toggle="tab" aria-expanded="<cfoutput>#notes_expand#</cfoutput>" class="nav-link<cfif #notes_expand# is " true"="true"">
                                        active</cfif>">Notes
