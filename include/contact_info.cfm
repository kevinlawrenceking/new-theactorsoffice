...
<cfsavecontent variable="varcheck">
  <cfoutput>
                  ...
                  <cfoutput>
                    T1: #t1#<BR>
                      T2: #t2#<BR>
                        ...
                        <cfif #dbugz# is "Y">
                          <cfoutput>
                            varif:#varif#<BR>varafter:#varafter#</cfoutput>
                            <cfoutput>
                          ...
                          <script>
                            $(document).ready(function () {
                              $("#remoteUpdateSUID0").on("show.bs.modal", function (event) {
                                ...
                                $(this)
                                  .find(".modal-body")
                                  .load("<cfoutput>/include/remoteUpdateSUID.cfm?suid=0&contactid=#currentid#</cfoutput>");
                              });
                            });
                          </script>
                            ...
                            <script>
                              $(document).ready(function () {
                                $("#remoteUpdate<cfoutput>SUID#ru.suid#</cfoutput>").on("show.bs.modal", function (event) {
                                  ...
                                  $(this)
                                    .find(".modal-body")
                                    .load("<cfoutput>/include/remoteUpdateSUID.cfm?suid=#ru.suid#&contactid=#currentid#</cfoutput>");
                                });
                              });
                            </script>
                            ...
                            <script>
                              $(document).ready(function () {
                                $("#remoteUpdate<cfoutput>C#cu.itemid#</cfoutput>").on("show.bs.modal", function (event) {
                                  ...
                                  modal
                                    .find(".modal-body")
                                    .load("<cfoutput>/include/remoteupdatec.cfm?userid=#userid#&itemid=#cu.itemid#</cfoutput>", function () {
                              ...
                              <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <h4 class="modal-title">
                                      Update
                                      <cfoutput>#cu.valueCategory# Form</cfoutput>
                                    </h4>
                                    <button type="button" class="close" data-bs-dismiss="modal">
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                      ...
                                      <p>
                                        ...
                                        #this.formatDate(sysactive.sustartdate)#</p>
                                      <cfif #sysactive.suenddate# is not "">
                                        <p>
                                          <strong>Completed:</strong>
                                          #this.formatDate(sysactive.suenddate)#</p>
                                      </cfif>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <script>
                                $(document).ready(function () {
                                  $("##remoteDeleteForm#sysActive.suid#").on("show.bs.modal", function (event) {
                                    ...
                                    $(this)
                                      .find(".modal-body")
                                      .load("/include/remoteDeleteForm.cfm?recid=#sysActive.suid#&rpgid=40&pgaction=update&contactid=#currentid#&pgdir=contact&t4=1");
                                  });
                                });
                              </script>
                            ...
                            <script>
                              $(document).ready(function () {
                                $("#remoteAdd<cfoutput>C#c.catid#</cfoutput>").on("show.bs.modal", function (event) {
                                  $(this)
                                    .find(".modal-body")
                                    .load("<cfoutput>/include/remoteAddC.cfm?catid=#c.catid#&userid=#userid#&contactid=#currentid#</cfoutput>", function () {
                                      // Initialize Parsley.js for the dynamically loaded form
                                      $(this)
                                        .find("form")
                                        .parsley();
                                ...
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <h4 class="modal-title">New
                                      <cfoutput>#c.valueCategory# Form</cfoutput>
                                    </h4>
                                    <button type="button" class="close" data-bs-dismiss="modal">
                                      <i class="mdi mdi-close-thick"></i>
                                    </button>
                          ...
                          <script>
                            $(document).ready(function () {
                              $("#remoteUpdateTag").on("show.bs.modal", function (event) {
                                ...
                                $(this)
                                  .find(".modal-body")
                                  .load("<cfoutput>/include/remoteUpdateTag.cfm?contactid=#currentid#</cfoutput>");
                              });
                            });
                          </script>
                          ...
                          <script>
                            $(document).ready(function () {
                              $("#remoteNewForm").on("show.bs.modal", function (event) {
                                ...
                                $(this)
                                  .find(".modal-body")
                                  .load("<cfoutput>/include/RemoteNewForm.cfm?rpgid=36&pgid=3&t2=1&pgdir=#pgdir#&contactid=#contactid#</cfoutput>");
                              });
                            });
                          </script>
                                ...
                                <div class="modal-body p-4">
                                  <div class="text-center">
                                    ...
                                    <p class="mt-3 text-white">
                                      <cfoutput>#details.recordname#</cfoutput>
                                      has been automatically placed into a maintenance list system.
                                    </p>
                            ...
                            <script>
                              $(document).ready(function () {
                                $("##remoteDeleteForm#currentid#").on("show.bs.modal", function (event) {
                                  ...
                                  $(this)
                                    .find(".modal-body")
                                    .load("/include/remoteDeleteForm.cfm?recid=#currentid#&rpgid=#pgid#&pgaction=update&pgdir=#pgdir#");
                                });
                              });
                            </script>
                          ...
                          <script>
                            $(document).ready(function () {
                              $("#remoteUpdateName").on("show.bs.modal", function (event) {
                                ...
                                $(this)
                                  .find(".modal-body")
                                  .load("<cfoutput>/include/remoteUpdateName.cfm?contactid=#currentid#&userid=#userid#</cfoutput>");
                              });
                            });
                          </script>
                                  ...
                                  <div class="modal-dialog">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        ...
                                        <p>&nbsp;</p>
                                        <center>
                                          <h5>Click confirm and we'll close it out and add the next reminder</h5>
                                        </center>
                                        <p>&nbsp;</p>
                                        <p>
                                          <center>
                                  ...
                                  <script>
                                    $(document).ready(function () {
                                      $("##remoteDeleteForm#recid#").on("show.bs.modal", function (event) {
                                        ...
                                        $(this)
                                          .find(".modal-body")
                                          .load("/include/remoteDeleteForm.cfm?recid=#contactid#&rpgid=#3#&pgaction=update&pgdir=#pgdir#");
                                      });
                                    });
                                  </script>
                                ...
                                <div class="py-1 px-3 flex text-center font-22">
                                  ...
                                  <cfif #emailcheck.recordcount# is "1">
                                    ...
                                    <cfoutput>
                                      ...
                                      <a href="mailto:#email#" class="<cfoutput>#tool_button#</cfoutput>" data-bs-="data-bs-" data-bs-placement="top" title="" data-bs-original-title="Email">
                                  ...
                                  <cfif #phonecheck.recordcount# is "1">
                                    ...
                                    <cfoutput>
                                      ...
                                      <a href="tel:#anchorPhoneNumber#" class="<cfoutput>#tool_button#</cfoutput>" data-bs-="data-bs-" data-bs-placement="top" title="" data-bs-original-title="Voice Call">
                                        ...
                                        <cfoutput>
                                          ...
                                          <centeR>
                                            ...
                                            <cfif NOT fileExists(avatar_path)>
                                              ...
                                              <img src="#default_avatar#" class="mr-3 rounded-circle gambar img-responsive img-thumbnail w-100" style="max-width:180px;
         alt=" profile-image"
         id=" item-img-output" />
    ...
    <cftry>
        ...
        <cfif NOT directoryExists(session.userContactsPath & "="item-img-output" />

    <cftry>

        <cfif NOT directoryExists(session.userContactsPath & "" /" & currentid)>
            <cfdirectory action=" create" directory=" #session.userContactsPath="#session.userContactsPath" &="&" "/" currentid#"="currentid#"">
                                              </cfif>

                                              <!--- Copy the default avatar to the user's contact directory --->
                                              <cffile action="copy" source="#application.defaultAvatarUrl#" destination="#avatar_path#">
                                          ...
                                          <cfelse>
                                            ...
                                            <img src="#contact_avatar#?rev=#rand()#" class="mr-3 rounded-circle gambar img-responsive img-thumbnail w-100" style="max-width:180px;" alt="profile-image" id="item-img-output"/>
                                          </cfif>
                                ...
                                <div class="card-body">
                                  ...
                                  <p class="mt-1 mb-0 py-1 text-muted font-14">
                                    ...
                                    <cfif #tagscontact.recordcount# is not "0">
                                      ...
                                      <a href="javascript:;" data-bs-remote="true" data-bs-toggle="modal" data-bs-target="#remoteUpdateTag" data-bs-placement="bottom" title="Update Tag" data-bs-original-title="Update Tag">
                                        <small>
                                  ...
                                  <p class="mt-1 mb-0 text-muted py-1 font-14">
                                    <cfoutput>
                                      ...
                                      <cfif #details.contactpronoun# is not "">#details.contactpronoun#
                                      </cfif>
                                    </cfoutput>
                                  </p>
                                  ...
                                  <p class="mt-1 mb-0 text-muted py-1 font-14">
                                    ...
                                    <cfif #details.referdetailsfullname# is not "">
                                      <cfoutput>#details.referdetailsfullname#</cfoutput>
                                    </cfif>
                                  </p>
                                  ...
                                  <cfif #details.newsletter_yn# is "Y" or #details.googlealert_yn# is "Y" or #details.socialmedia_yn# is "Y">
                                    ...
                                    <p class="mt-1 mb-0 text-muted py-1  font-14">
                                      ...
                                      <cfif #details.newsletter_yn# is "Y">
                                        ...
                                        <span class="badge badge-outline-blue rounded-pill">
                                          &#10004; Newsletter</span>
                                    ...
                                    <p class="mt-1 mb-0 text-muted font-18">
                                      ...
                                      <cfloop query="profiles">
                                        ...
                                        <cfoutput>
                                          ...
                                          <a href="#profiles.valuetext#" class="text-white font-14 py-1 ps-o me-2   d-inline-block" data-bs-="data-bs-" data-bs-placement="top" title="" target="#profiles.valuetext#" data-bs-original-title="#profiles.valuetype#">
                          ...
                          <cfelse>
                            ...
                            <div class="card mb-3">
                              ...
                              <div class="card-body">
                                <ul class="nav nav-pills navtab-bg nav-justified p-1" role="tablist">
                                  ...
                                  <li class="nav-item">
                                    ...
                                    <cfoutput>
                                      <a href="##notes" data-bs-toggle="tab" aria-expanded="#notes_expand#" class="nav-link<cfif #notes_expand# is " true"="true"">
                                        active</cfif>">Notes
                              ...
                              <div class="tab-content">
                                ...
                                <div class="tab-pane<cfif #notes_expand# is " true"="true"">
                                  show active</cfif>" id="notes">
                                <cfinclude template="/include/notes_relationship_pane.cfm"/>
                        ...
                        document.addEventListener("DOMContentLoaded", function () {
                          ...
                          $('.modal').on('hidden.bs.modal', function () {
                            ...
                            if (modalForm) {
                              ...
                              $(modalForm)
                                .parsley()
                                .reset(); // Reset Parsley validation state
