...
<cfif book_det.incometypeid neq "1">
    <style>
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6 col-sm-12">
            ...
            <select id="new_incometypeid" name="new_incometypeid" class="form-control" onChange="showDivs('hidden_divs', this);">
                <cfoutput query="incometypes_sel">
                    <option value="#incometypes_sel.id#" <cfif incometypes_sel.id eq book_det.incometypeid>selected</cfif>>#incometypes_sel.name#</option>
                </cfoutput>
            </select>
        </div>
        ...
        <div class="form-group col-md-6 col-sm-12">
            <div id="hidden_divs">
                ...
                <div class="invalid-feedback"> Please enter a Net Income. </div>
            </div>
        </div>
        ...
        <div class="form-group col-md-6 col-sm-12">
            ...
            <div class="invalid-feedback"> Please enter a Payrate. </div>
        </div>

        <!--- Pay Cycle Selection --->
        <div class="form-group col-md-6 col-sm-12">
            <label for="new_paycycleid">Pay Cycle</label>
            <select id="new_paycycleid" name="new_paycycleid" class="form-control">
                <cfoutput query="audpaycyles_sel">
                    <option value="#audpaycyles_sel.id#" <cfif audpaycyles_sel.id eq book_det.paycycleid>selected</cfif>>#audpaycyles_sel.name#</option>
                </cfoutput>
            </select>
        </div>

        <!--- Conditional Buyout Input for Commercial Category --->
        <cfif book_det.audcatname eq "Commercial">
            <div class="form-group col-md-6 col-sm-12">
...
<!--- Modifications were made according to the following rules: 2, 3, 5, 6, 9, 10. --->