        ...
        <div class="custom-group custom-checkbox">
            <div style="margin-left:25px;">
                <label class="custom-control-label">
                    <input type="checkbox" name="new_trackmileage" class="custom-control-input" id="trackmileage" value="1" <cfif aud_det.trackmileage is "1" >
 checked </cfif>>
        ...
        <cfoutput>
            <div class="form-group col-md-12">
                <div class="custom-group custom-checkbox">
                    <div style="margin-left:25px;">
                        <label class="custom-control-label">
                            <input type="checkbox" class="custom-control-input" id="workwithcoach" value="1" <cfif #aud_det.workwithcoach# is "1" >
