                            ...
                            <div class="col">
                                <cfoutput>
                                    <a class="dropdown-icon-item" href="https://theactorsoffice.helpwise.help/" target="FAQ">
                                        <img src="#iapplication.imagesUrl#/faq.png?ver=3" alt="FAQ">
                                        <span>FAQ</span>
                                    </a>
                                </cfoutput>
                            </div>
                            <div class="col">
                                <cfoutput>
                                    <a class="dropdown-icon-item" href="https://www.facebook.com/groups/taousercommunity" target="usercommunity">
                                        <img src="#iapplication.imagesUrl#/usercom.png?ver=3" alt="User Community">
                                ...
                                <div class="col">
                                    <cfoutput>
                                        <a href="remoteSupportForm.cfm" data-bs-remote="true" data-bs-toggle="modal" data-bs-target="##remoteSupportForm" class="dropdown-icon-item">
                                            <img src="#iapplication.imagesUrl#/feedback.png?ver=3" alt="Feedback">
                            ...
                            <div class="col">
                                <cfoutput>
                                    <a class="dropdown-icon-item" href="mailto:support@theactorsoffice.com?subject=I%20Need%20Some%20Support%20with%20TAO">
                                        <img src="#iapplication.imagesUrl#/contact.png?ver=3" alt="Contact Support">
        ...
        <Cfoutput>
            <div class="logo-box">
                <a href="/app/" class="logo logo-dark text-center">
                    <span class="logo-sm">
                        <img src="#iapplication.imagesUrl#/logo-sm.png" alt="" height="30">
                    </span>
                    <span class="logo-lg">
                        <img src="#iapplication.imagesUrl#/logo-sm.png" alt="" height="30">
                    </span>
                ...
                <a href="/app/" class="logo logo-light text-center">
                    ...
                    <span class="logo-lg">
                        <img src="#iapplication.imagesUrl#/logo-light.png" alt="" height="30">
                    </span>
                </a>
            </div>
        </cfoutput>
