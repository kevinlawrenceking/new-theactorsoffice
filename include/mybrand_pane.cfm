        ...
        <cfloop query="essence_sel">
            <div class="col-md-2 col-lg-3 col-sm-12"> 
                <cfoutput>
                    ...
                    <p class="p-2">
                        <a href="" data-bs-remote="true" data-bs-toggle="modal" data-bs-target="##remoteUpdateEssenceContact_#essence_sel.id#">
                            <button type="button" class="btn btn-soft-secondary rounded-pill waves-effect">#Essence_sel.Name#</button>
                        </a>
                    </p>
                </cfoutput>
                <br>
