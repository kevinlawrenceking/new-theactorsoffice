                                ...
                                <div class="text-center w-85 m-auto">
                                    <div class="auth-logo">
                                        <a href="index.html" class="logo logo-dark text-center">
                                            <span class="logo-lg">
                                                <img src="<cfoutput>#application.application.imagesUrl#/taowhite.png</cfoutput>" alt="" height="60">
                                            </span>
                                        </a>
                    
                                        <a href="index.html" class="logo logo-light text-center">
                                            <span class="logo-lg">
                                                <img src="<cfoutput>#application.application.imagesUrl#</cfoutput>/logo-dark.png" alt="" height="20">
                                            </span>
                                        </a>
                                    </div>
                                    <h5>Account Setup</h5>
